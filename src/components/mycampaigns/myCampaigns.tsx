...
//                   <DialogDescription>
//                     Your campaign has been created and the Hypercert has been
//                     minted.
//                   </DialogDescription>
//                 </DialogHeader>
//                 <div className="py-4">
...
//                   <DialogDescription>
//                     Set up your new donation campaign here. You'll be able to
//                     mint your Hypercert NFT after creation.
//                   </DialogDescription>
//                 </DialogHeader>
...
//                         onChange={(e) =>
//                           handleMultiInputChange("impactScope", e.target.value)
//                         }
...
//                         onChange={(e) =>
//                           handleMultiInputChange("workScope", e.target.value)
//                         }
...
//                     <div className="grid grid-cols-4 items-center gap-4">
//                       <Label htmlFor="excludedWorkScope" className="text-right">
//                         Excluded Work Scope
//                       </Label>
//                       <Input
...
//                     <div className="grid grid-cols-4 items-center gap-4">
//                       <Label htmlFor="workTimeframeEnd" className="text-right">
//                         Work Timeframe End
//                       </Label>
//                       <Input
//                         id="workTimeframeEnd"
...
//                     </div>
//                     <div className="grid grid-cols-4 items-center gap-4">
//                       <Label htmlFor="contributors" className="text-right">
//                         Contributors
//                       </Label>
//                       <Input
//                         id="contributors"
...
//                         onChange={(e) =>
//                           handleMultiInputChange("contributors", e.target.value)
//                         }
...
//                     <div className="grid grid-cols-4 items-center gap-4">
//                       <Label htmlFor="excludedRights" className="text-right">
//                         Excluded Rights
//                       </Label>
//                       <Input
//                         id="excludedRights"
...
//           >
//             <CardHeader>
//               <CardTitle className="text-purple-700">{campaign.name}</CardTitle>
//             </CardHeader>
//             <CardContent>
